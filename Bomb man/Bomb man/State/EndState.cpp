...
{
    if(!this -> font.loadFromFile("/Users/tu/Documents/研究所/08_projects/BomberMan-Game-main/Bomb man/Bomb man/Fonts/The Army Of God.ttf"))
    {
...
void EndState::initBackGround()
{
    if(this -> winner == 1)
    {
        bgtexture.loadFromFile("/Users/tu/Documents/研究所/08_projects/BomberMan-Game-main/Bomb man/Bomb man/images/player1wins.png");
    }
    else if(this -> winner == 2)
    {
        bgtexture.loadFromFile("/Users/tu/Documents/研究所/08_projects/BomberMan-Game-main/Bomb man/Bomb man/images/player2wins.png");
    }
    else if(this -> winner == 3)
    {
        bgtexture.loadFromFile("/Users/tu/Documents/研究所/08_projects/BomberMan-Game-main/Bomb man/Bomb man/images/drawscreen.png");
    }
