...
GameClock::GameClock()
{
    if(! font.loadFromFile("/Users/tu/Documents/研究所/08_projects/BomberMan-Game-main/Bomb man/Bomb man/Fonts/The Army Of God.ttf"))
    {
        std::cout << "Error Loading font file in GameLock.cpp" << std::endl;
        system("pause");
    }
    if (!countDownBuffer.loadFromFile("/Users/tu/Documents/研究所/08_projects/BomberMan-Game-main/Bomb man/Bomb man/Sound/CountDown.wav"))
    {
